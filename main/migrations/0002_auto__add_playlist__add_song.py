...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding SortedM2M table for field songs on 'Playlist'
        db.create_table('main_playlist_songs', (
        ...
        db.create_unique('main_playlist_songs', ['playlist_id', 'song_id'])
        # Adding model 'Song'
        db.create_table('main_song', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('time_requested', self.gf('django.db.models.fields.DateTimeField')(blank=True, auto_now_add=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('main_playlist_songs'))
